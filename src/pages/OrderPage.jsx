          ...
          <div className='container m-auto lg:px-8 lg:py-2 sm:px-4'>
            <div className='sm:mx-0'>
              <div className="flex flex-col lg:flex-row items-center gap-2">
                {/* Section kiri */}
                <div data-aos='slide-up' data-aos-duration='800' className="w-full lg:w-1/2 py-6 px-4 lg:px-10 sm:py-6 md:px-2 text-center lg:text-left">
                ...
                {/* Section kanan */}
                <div data-aos='fade-up' data-aos-duration='600' className='bg-secondary dark:bg-primary rounded-xl w-full lg:w-1/2 py-2 flex justify-center'>
                  <div className='py-3'>
                    <h1 data-aos='zoom-out' data-aos-duration='600' className='font-poetsen text-2xl mb-3 flex justify-center'>
                      Pemesanan Melalui Whatsapp
                    </h1>
                  <form onSubmit={ handleSubmit }>
                      <div data-aos='zoom-out' data-aos-duration='600' className='mb-2'>
                      ...
                      <div data-aos='zoom-out' data-aos-duration='600' className='flex flex-row mb-2 gap-2'>
                      ...
                      <button data-aos='zoom-out' data-aos-duration='600'
                        type="submit"
